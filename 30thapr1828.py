...
srcc1_new,uncertainty1_new = calc_srcc(spindown_rate_new,SP1_res_new)
srcc2_new,uncertainty2_new = calc_srcc(spindown_rate_new,SP2_res_new)
srcc3_new,uncertainty3_new = calc_srcc(spindown_rate_new,SP3_res_new)
srcc4_new,uncertainty4_new = calc_srcc(spindown_rate_new,SP4_res_new)
...
print(f'{srcc1_new}±{uncertainty1_new}')
print(f'{srcc2_new}±{uncertainty2_new}')
print(f'{srcc3_new}±{uncertainty3_new}')
print(f'{srcc4_new}±{uncertainty4_new}')
